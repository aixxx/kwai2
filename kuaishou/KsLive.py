...
class Tool:
    ...
    funHost = 'https://funadmin.haitao.com'
    # 进入房间时需要的token
    token = ''
    # 网页token
    cookie = ''
    ...
    def parseEnterRoomAckPack(self, message: bytes):
        ...
        logging.info('[parseEnterRoomAckPack] [进入房间成功ACK应答👌] [RoomId:' + self.liveRoomId + ']')
        return data
    ...
    def parseHeartBeatPack(self, message: bytes):
        ...
        logging.info('[心跳❤️响应] [RoomId:' + self.liveUrl + '] ｜ ')
        return data
    ...
    def onOpen(self):
        ...
        _thread.start_new_thread(self.keepHeartBeat, (self.ws,))
